using UnityEngine;
  ...
  public class CarEngineController
  {
      ...
      private void UpdateTachometer()
      {
          ...
          if (_carData.carDial.tachometer >= RevLimiterRPM)
          {
              targetRPM = RevLimiterRPM;
          }
  
          if (_carData.gearStatus != 0 && !_carData.isGasPressed && !_carData.isClutchPressed)
          {
              targetRPM = Mathf.Max(_carData.carDial.tachometer - 300f * Time.deltaTime, 0f);
          }
      ...
      private void UpdateSpeed()
      {
          ...
          {
              _carData.carDial.currentSpeed = 0f;
              return;
          }
          ...
          _carData.carDial.currentSpeed = Mathf.Max(0, _rigidbody.velocity.magnitude * 3.6f);
      }
  
      private void CheckForEngineStop()
      {
          if (_carData.carDial.tachometer < MinRPMForStop && !_carData.isClutchPressed && _carData.gearStatus != 0)
          {
